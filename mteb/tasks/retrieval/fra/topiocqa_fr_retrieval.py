...
class FrTopiOCQARetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="FrTopiOCQARetrieval",
        dataset={
            "path": "DeepPavlov/topiocqa_fr",
            "revision": "3cb6238bcd5876f79a25ef482ac61c63c3fbaf09",
        },
        ...
        description=(
            ...
            + "Unlike the pre-built mteb/TopiOCQA corpus/queries/qrels split, DeepPavlov/topiocqa_fr ships the "
